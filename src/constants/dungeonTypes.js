...
export const GROUND2 = 11;
export const GROUND3 = 12;
export const GROUND4 = 13;
...
//tile strings
export const STR_WALL = "wall";

export const STR_GROUND_1 = "ground";
export const STR_GROUND_2 = "ground2";
export const STR_GROUND_3 = "ground3";
export const STR_GROUND_4 = "ground4";
export const STR_GROUND_5 = "ground5";
...
lowest number is the object shown.
